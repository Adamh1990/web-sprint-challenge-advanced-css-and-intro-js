...
Adjust font-sizes that will act upon selection of the user
Make sure all alt attributes are filled out
Use %'s for sizing to ensure the layout isn't compromised depending on device
