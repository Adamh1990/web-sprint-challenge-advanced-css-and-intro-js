...
1. How would you describe acessibility on the web to someone new to programming?
    Acessibility means making a website usable for all varieties of people and devices. To make sure the site can be adjusted for size, etc. and also be viewed comfortably on computers, cell phones, tables, or a watch!

2. Talk about 3 different things you can do to ensure your website is accessible. 
    Clean coding for organization, media queries for multiple devices, proper CSS layout.

3. How would you explain the concept of a variable to someone new to programming?
    Variables are essentially 'containers', reference points that can be brought up later to put information into categories to be called upon later.

4. What is the purpose of using functions in code?
    A function is a set of tasks to be carried out to obtain some goal
